...
try {
 ...
 setUserData(result.data)
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-start items-center px-[180px]' style={{backgroundImage:`url(${bg})`}} >
...
<h1 className='text-white text-[30px] font-semibold mb-[30px]'>Register to <span className='text-blue-400'>Personal Assistant</span></h1>
